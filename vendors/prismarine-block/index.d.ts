...
/** @deprecated */
declare function loader(mcVersion: string): typeof Block;
declare function loader(registry: ReturnType<typeof Registry>): typeof Block;
